...
def main():
    ...
    final = "./results/final_data.csv"
    backup = "./results/final_data_backup.csv"
    ...
    if not initial:
        ...
        new_data_df = new_data_df[new_data_df["_merge"] == "left_only"].drop(
            columns=["_merge"]
        )
